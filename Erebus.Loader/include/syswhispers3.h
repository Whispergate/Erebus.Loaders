...
typedef DWORD SE_SIGNING_LEVEL, * PSE_SIGNING_LEVEL;
#define SE_SIGNING_LEVEL_UNSIGNED   0
#define SE_SIGNING_LEVEL_ENTERPRISE  2
#define SE_SIGNING_LEVEL_CUSTOM_5     5
#define SE_SIGNING_LEVEL_MICROSOFT    6
